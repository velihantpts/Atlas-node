...
const PersonEditPage = ({ id }) => {
    ...
    fetch(`/api/restaurant/${id}`, {
      ...
      .then(response => {
        if (response.ok) {
          ...
          console.error('Restaurant güncellenirken bir hata oluştu.');
        }
      })
      .catch(error => {
        console.error('Restaurant güncellenirken bir hata oluştu:', error);
      });
  };
  ...
  return (
    ...
    <div className='ml-64 p-5 px-10'>
         <h1 className=' font-sans font-semibold   mt-10 pl-16 text-left w-full'>Restaurantlar </h1>
        <Sidebar />
        <div class="  ">
   <div class="p-4">
...
<input
                  ...
                  />       
    <label for="floating_company" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Restaurant Acıklaması</label>
</div>
</div>
